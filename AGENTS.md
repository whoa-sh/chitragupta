...
This repository is a Kotlin Spring Boot enterprise service (`chitragupta`).
...
- `sh.whoa.chitragupta.core`: Shared base entities and JPA optimizations.
- `sh.whoa.chitragupta.util`: High-performance internal utilities (UUIDv7, etc).
