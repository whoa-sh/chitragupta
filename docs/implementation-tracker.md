...
| T5 | Add CI sanity workflow | done | PR and master checks run; lint/build in parallel; no publish in PR | `actionlint` clean for workflow files; compose app remained healthy | pending | `.github/workflows/ci.yml` |
